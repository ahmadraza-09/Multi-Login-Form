...
const PageOneComp = () => {
  return (
    <>
    <div className='h-screen w-full container flex items-center justify-center'>
      <form className='w-[450px]  border-black mx-auto my-auto flex flex-col gap-4'>
        <h1 className='font-extrabold text-2xl'>Welcome! Let's Create your profile</h1>
        ...
        <div className='flex flex-col gap-4'>
            ...
            <div className='flex space-x-6'>
                <div className='w-[100px] h-[100px] border-2 border-dashed border-gray-400 text-gray-500 rounded-full flex items-center justify-center'><i class="fa-solid fa-camera"></i></div>
                <div className='flex flex-col gap-4'>
