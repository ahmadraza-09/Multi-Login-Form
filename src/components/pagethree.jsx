...
const PageThreeComp = () => {
  ...
  return (
    ...
    <div className='h-screen w-full container flex items-center justify-center relative m-auto'>
      <i class="fa-solid fa-angle-left text-xl absolute top-4 left-44 bg-gray-200 w-8 h-8 text-center justify-center items-center flex cursor-pointer md:left-10 sm:left-10 sd:left-6 xs:left-4"></i>
